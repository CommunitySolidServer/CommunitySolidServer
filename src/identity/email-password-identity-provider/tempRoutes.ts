...
// import { Router } from '@bessonovs/node-http-router';

// const body = urlencoded({ extended: false });

// const keys = new Set();
// const debug = (obj) => querystring.stringify(Object.entries(obj).reduce((acc: Record<string, >, [key, value]) => {
//   keys.add(key);
...
// export default function getRoutes(router: Router, provider) {
