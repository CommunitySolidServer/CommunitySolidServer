 ...
 * Cookies have a specified time to live in minutes, default is 14 days,
 * after which they will be removed.
 * Every call to the `get` function resets the timer for that cookie.
 */
export class BaseCookieStore implements CookieStore {
  private readonly storage: ExpiringStorage<string, string>;
  private readonly ttl: number;

  public constructor(storage: ExpiringStorage<string, string>, ttl = 14 * 24 * 60) {
