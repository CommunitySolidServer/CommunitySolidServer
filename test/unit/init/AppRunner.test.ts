      ...
      expect(manager.instantiate).toHaveBeenCalledWith(
        'urn:solid-server:default:App',
        {
          variables: {
            ...
            'urn:solid-server:default:variable:tempFilePath': '/var/cwd/tmp',
      ...
      expect(manager.instantiate).toHaveBeenCalledWith(
        'urn:solid-server:default:App',
        {
          variables: {
            ...
            'urn:solid-server:default:variable:tempFilePath': '/temp',
      ...
      expect(manager.instantiate).toHaveBeenCalledWith(
        'urn:solid-server:default:App',
        {
          variables: {
            ...
            'urn:solid-server:default:variable:tempFilePath': '/var/cwd/temp',
            'urn:solid-server:default:variable:sparqlEndpoint': 'http://localhost:5000/sparql',
            'urn:solid-server:default:variable:showStackTrace': true,
            'urn:solid-server:default:variable:podConfigJson': '/different-path.json',
          },
